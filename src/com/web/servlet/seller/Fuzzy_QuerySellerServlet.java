...
@WebServlet("/sellerFuzzyQuery")
public class Fuzzy_QuerySellerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Seller> Seller_list = dao.Fuzzy_querySeller(new Seller(null,s_seller));
        //创建一个HashMap集合对象

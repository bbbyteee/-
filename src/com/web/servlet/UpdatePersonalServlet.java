...
//@WebServlet用于配置当前的请求访问的地址  /personalUpdate
...
public class UpdatePersonalServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //1、获取请求中提交的userid和usernickname等   【使用getParameter方法根据key来获取value】
        ...
        //构建User 对象
        User user = new User(u_id, u_nickname, null, u_name, u_sex, 0, u_phone, null);
        // 2、创建dao 的对象，然后调佣dao方法
        UserDao dao = new UserDao();
        User user1 = dao.updatePersonal(user);
        // 3、判断是否修改成功
        if (user1!=null) {
            result.put("ok", true);
